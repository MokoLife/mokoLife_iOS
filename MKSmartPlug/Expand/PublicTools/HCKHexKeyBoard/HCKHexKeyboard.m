...
@interface HCKHexKeyboard()

@property (nonatomic, strong)UIView *topView;

@property (nonatomic, strong)UIView *bottomView;

@property (nonatomic, copy)HCKHexKeyboardInputValueChangedBlock keyboardBlock;

@property (nonatomic, copy)NSString *keyboardValue;

@end

@implementation HCKHexKeyboard
...
- (UIButton *)hexButton:(NSString *)title titleColor:(UIColor *)color{
    ...
    [hexBtn.titleLabel setFont:HCKFont(18.f)];
...
- (void)loadKeyButtons{
    ...
    [doneBtn.titleLabel setFont:HCKFont(20.f)];
...
- (void)showHexKeyboardBlock:(HCKHexKeyboardInputValueChangedBlock)block{
