...
- (void)handleAccessCamera:(NSInvocation *)allowInvocation
{
    ...
    NSString *promtpMessage = LS(@"HCKSystemResource_camera");
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:nil
                                                                             message:promtpMessage
                                                                      preferredStyle:UIAlertControllerStyleAlert];
    UIAlertAction *cancelAction = [UIAlertAction actionWithTitle:LS(@"HCKAdvancedController_cancel")
                                                           style:UIAlertActionStyleCancel
                                                         handler:nil];
    
    UIAlertAction *okAction = [UIAlertAction actionWithTitle:LS(@"HCKAdvancedController_ok")
...
- (void)handleAccessPhotos:(NSInvocation *)allowInvocation{
    ...
    NSString *promtpMessage = LS(@"HCKSystemResource_photo");
...
- (void)handleAccessMicrophone:(NSInvocation *)allowInvocation{
    ...
    NSString *promtpMessage = LS(@"HCKSystemResource_video");
