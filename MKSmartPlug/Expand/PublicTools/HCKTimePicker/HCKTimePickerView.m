...
@implementation HCKTimerPickerModel
...
- (UIView *)bottomView{
    if (!_bottomView) {
        ...
        [cancelButton setTitle:LS(@"HCKTimePickerView_cancel") forState:UIControlStateNormal];
        ...
        [confirmBtn setTitle:LS(@"HCKTimePickerView_confirm") forState:UIControlStateNormal];
